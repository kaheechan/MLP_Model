...
class Dataset_Loader(dataset):
    ...
    def load_data(self):
        ...
        if self.dataset_name == 'cora':
            idx_train = range(0, 1895)
            idx_test = range(2165, 2708)
            idx_val = range(1895, 2165)
        elif self.dataset_name == 'citeseer':
            idx_train = range(0, 1656) # 50%
            idx_val = range(1656, 2484) # 25%
            idx_test = range(2484, 3312)  # 25%
        elif self.dataset_name == 'pubmed':
            idx_train = range(0, 13802)
            idx_val = range(13802, 17745)
            idx_test = range(17745, 19717)
